  ...
  if (!loading && recipes.length === 0) {
    return (
      <EmptyState
        ...
        description="Chưa có công thức nào trong hệ thống."
      />
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <button
          ...
          className="px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-2xl hover:shadow-lg hover:shadow-blue-500/30 active:scale-95 transition-all"
        >
          Tìm kiếm
        </button>
      </div>
