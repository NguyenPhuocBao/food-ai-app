...
import { Settings, LogOut, Activity, ShieldCheck, Calendar, Lock, User as UserIcon, Bell, Target, Smartphone, Flame } from 'lucide-react';
        ...
        <div className="lg:col-span-9 space-y-6">
           ...
           <div className="bg-white border border-gray-100 rounded-[24px] shadow-sm p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                 <div className="space-y-6">
                    <div>
                       ...
                       <input 
                         type="text" 
                         defaultValue={user?.name || 'Nguyễn Phước'} 
                    ...
                    <div>
                       ...
                       <input 
                         type="email" 
                         defaultValue={user?.email || 'nguyenphuoc@example.com'} 
                 ...
                 <div className="space-y-6">
                    ...
                    <div>
                       ...
                       <select className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-gray-900 focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 font-medium appearance-none">
                         <option>Nhẹ nhàng (Văn phòng, ít vận động)</option>
                         <option selected>Vừa phải (Tập thể dục 3-5 ngày/tuần)</option>
                         <option>Cao (Chơi thể thao thường xuyên)</option>
                       </select>
                    </div>
                 </div>
              </div>
              ...
              <div className="border-t border-gray-100 mt-8 pt-6 flex justify-end">
                <button className="bg-emerald-500 hover:bg-emerald-600 px-6 py-3 rounded-xl text-white font-bold transition-colors shadow-sm">
                  Cập nhật thông tin
                </button>
              </div>
           </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
             <div className="bg-emerald-500 text-white rounded-[24px] p-6 shadow-lg shadow-emerald-500/20 relative overflow-hidden flex flex-col justify-between h-40">
                ...
                <span className="text-4xl font-black relative z-10">22.4 <span className="text-sm font-bold text-emerald-200">Bình thường</span></span>
             </div>
