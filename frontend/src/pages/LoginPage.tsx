        ...
        <div className="absolute bottom-0 left-0 p-12 z-20 w-full">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 leading-tight">
              Trợ Lý AI <br /> Tư Vấn Bữa Ăn
            </h1>
            <p className="text-gray-300 text-lg max-w-md">
              Hệ thống trí tuệ nhân tạo sẽ phân tích nhu cầu và đưa ra các đề xuất dinh dưỡng thông minh dành riêng cho bạn.
            </p>
          </motion.div>
        </div>
      </div>
            ...
            <div className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <a href="#" className="text-xs font-medium text-green-600 hover:text-green-500 transition-colors">
                    Quên mật khẩu?
                  </a>
                </div>
                <div className="relative group">
