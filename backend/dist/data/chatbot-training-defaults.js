...
exports.DEFAULT_CHATBOT_TRAINING_EXAMPLES = void 0;
...
const safetyAlerts = [
    {
        ...
        answer: 'Neu co dau nguc, kho tho, ngat, choang nang, non lien tuc, sot cao keo dai, hoac duong huyet/huyet ap bat thuong, can di kham ngay. Chatbot khong thay the chan doan y khoa.',
    ...
    },
    {
        ...
        answer: 'Khong nen tu y an kieng muc qua chat trong thai ky. Can trao doi bac si/chan doan dinh duong de co phac do phu hop.',
...
const customDirectQAs = [
    {
        question: 'Toi tien tieu duong, bua sang nao de on dinh duong huyet?',
        answer: 'Ban co the an sua chua khong duong + yach mach + hat chia + 1 it trai cay it ngot. Uu tien dam + chat xo, han che nuoc ngot va banh ngot buoi sang.',
        tags: ['custom', 'tien tieu duong', 'bua sang'],
    },
    {
        question: 'Toi dang uong thuoc huyet ap, co can kieng muoi tuyet doi khong?',
        answer: 'Khong can cat muoi ve 0, nhung can giam man ro rang: han che mon dong hop, nuoc cham man, mon kho. Muc tieu tong muoi duoi 5g/ngay theo huong dan chung.',
        tags: ['custom', 'cao huyet ap', 'muoi'],
    },
    {
        question: 'Toi co mo mau cao, bua toi nen uu tien nhom mon nao?',
        answer: 'Uu tien ca, dau hu, rau xanh, tinh bot nguyen hat va dau hat. Han che mon chien ngap dau, noi tang, thit mo va do an nhanh.',
        tags: ['custom', 'mo mau cao', 'bua toi'],
    },
    {
        question: 'Toi gout, co an duoc hai san khong?',
        answer: 'Voi gout, nen han che nhom hai san giau purin va phu tang. Uu tien dam nac vua du, uong du nuoc va theo doi acid uric theo lich bac si.',
        tags: ['custom', 'gout', 'purin'],
    },
    {
        question: 'Toi hay an theo cam xuc luc stress, can lam gi truoc khi mo do an?',
        answer: 'Dung lai 5 phut, uong 1 ly nuoc, di bo ngan, sau do moi quyet dinh an. Neu van doi, chon bua phu nho co dam + chat xo de tranh an qua da.',
        tags: ['custom', 'hanh vi', 'stress'],
    },
    {
        question: 'Toi lam ca dem, sap xep bua an the nao de khong tang can?',
        answer: 'Chia 2 bua nho va 1 bua chinh theo khung gio lam viec. Uu tien dam nac + rau + tinh bot vua du, tranh an qua nhieu do ngot gan cuoi ca.',
        tags: ['custom', 'ca dem', 'giam can'],
    },
    {
        question: 'Toi can giam can nhung van muon an com, co duoc khong?',
        answer: 'Duoc. Ban khong can bo com hoan toan, chi can giam khau phan, uu tien gao lut/nep cam, tang rau va dam nac de no lau.',
        tags: ['custom', 'giam can', 'carb'],
    },
    {
        question: 'Sau tap gym toi khong doi, co can an them khong?',
        answer: 'Neu muc tieu tang co, nen bo sung nhe sau tap: 25-35g protein va it carb de phuc hoi. Co the dung sua chua Hy Lap + trai cay it ngot.',
        tags: ['custom', 'sau tap', 'tang co'],
    },
    {
        question: 'Toi co da day nhay cam, bua toi nen tranh gi?',
        answer: 'Han che mon qua cay, qua chua, do chien nhieu mo va ca phe muon. Uu tien mon mem, de tieu, chia khau phan vua phai.',
        tags: ['custom', 'da day', 'bua toi'],
    },
    {
        question: 'Neu toi co benh than giai doan som thi co nen an protein cao de giam can?',
        answer: 'Khong nen tu y an protein qua cao. Can can doi dam theo huong dan bac si, dong thoi giam duong va chat beo xau de kiem soat can nang an toan.',
        tags: ['custom', 'benh than', 'an toan'],
    },
    {
        question: 'Toi muon menu 1 ngay de kiem soat huyet ap va duong huyet cung luc',
        answer: 'Mau 1 ngay: sang yach mach + sua chua khong duong; trua uc ga + rau + com gao lut; toi ca hap + rau luoc + khoai. Giam muoi, tranh nuoc ngot.',
        tags: ['custom', 'cao huyet ap', 'tieu duong'],
    },
    {
        question: 'Toi hay them tra sua, thay bang gi de de theo lau dai?',
        answer: 'Thu tra khong duong + sua it beo, hoac ca phe sua khong duong voi luong nho. Dat so lan co dinh/tu an thay vi kieng tuyet doi.',
    ...
    for (const playbook of customPlaybooks) {
        for (const meal of meals) {
            ...
            items.push({
                ...
                answer: `Voi nhom ${playbook.label}, ${meal.label} ban co the an ${protein} + ${veggie} + ${carb} voi khau phan vua du. Uu tien ${playbook.core} va ${playbook.avoid}.`,
        ...
        for (const meal of meals) {
            for (const protein of proteins) {
                ...
                items.push({
                    ...
                    answer: `Voi muc tieu ${goal.label}, ${meal.label} (${meal.timing}) co the an ${protein} + ${veggie} + ${carb} voi khau phan ${meal.portion}. Ban can ${goal.strategy} va ${goal.carbHint}.`,
        ...
        for (const meal of meals) {
            for (const carb of carbs) {
                ...
                items.push({
                    ...
                    answer: `Neu ban co ${condition.label}, ${meal.label} voi ${carb} can theo huong ${condition.avoid}. Ban co the ket hop ${protein} + rau xanh + mot it ${fat}; dong thoi ${condition.focus}.`,
        ...
        for (const phase of trainingPhases) {
            for (const snack of carbs) {
                ...
                items.push({
                    ...
                    answer: `Voi lich ${workout.label}, giai doan ${phase.label} ban nen uu tien ${phase.guide}. Co the dung ${snack} ket hop ${protein}; dong thoi ${workout.note}.`,
    ...
    for (const habit of habits) {
        for (const goal of goals) {
            ...
            items.push({
                ...
                answer: `${habit.advice}. De phu hop muc tieu ${goal.label}, hay uu tien ${meal.label} co ${protein} + ${veggie}, va theo doi 7-14 ngay de dieu chinh.`,
...
exports.DEFAULT_CHATBOT_TRAINING_EXAMPLES = buildGeneratedTrainingExamples();
