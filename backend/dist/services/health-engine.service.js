...
exports.normalizeGoalCalories = exports.evaluateDailyHealth = exports.buildWeeklyRecommendations = exports.evaluateMealHealth = void 0;
...
exports.evaluateMealHealth = evaluateMealHealth;
const buildWeeklyRecommendations = (dailyResults, targetCalories, hydration) => {
...
exports.buildWeeklyRecommendations = buildWeeklyRecommendations;
const evaluateDailyHealth = (date, meals) => {
    if (!meals.length) {
        return {
...
exports.evaluateDailyHealth = evaluateDailyHealth;
const normalizeGoalCalories = (value) => {
    if (!value || value <= 0)
        return 2000;
    return Math.max(1200, Math.min(4500, Math.round(value)));
};
exports.normalizeGoalCalories = normalizeGoalCalories;
